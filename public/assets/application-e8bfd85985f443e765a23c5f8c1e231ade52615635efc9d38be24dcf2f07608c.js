...
window.setupServerChannel = function () {
    ...
    document.addEventListener("turbolinks:load", () => {
        ...
        if (serverElement && messagesContainer) {
            ...
            App.cable.connection = App.cable.connection || App.cable.createConnection();
            console.log("App.cable connection state:", App.cable.connection.state);

            if (!App.cable) {
                console.error("App.cable is not defined. Check your consumer.js setup.");
            }
...
// Ensure the function is executed on Turbolinks page load
document.addEventListener("turbolinks:load", () => {
    const serverElement = document.getElementById("server-id");
    if (serverElement) {
        setupServerChannel();
