...
const updateUserStatus = (data) => {
    ...
    if (userElement) {
        ...
        userElement.classList.add(data.status); // Add new status
    } else {
...
// Manage user online/offline status updates
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (serverIdElement) {
        ...
        const sendStatusUpdate = (status) => {
            ...
            fetch(`/servers/${serverId}/update_status`, {
                method: "POST",
                headers: {
        ...
        // User joins the server page
        sendStatusUpdate("online");

        // User leaves the server page
        window.addEventListener("beforeunload", (event) => {
            navigator.sendBeacon(`/servers/${serverId}/update_status`, JSON.stringify({ status: "offline" }));
        });
    }
});
